...
# The Engagement APIs
    ...
    path('dashboard/company/services/new/', views.ServiceCreateView.as_view(), name='service_create'),
    path('dashboard/company/services/<uuid:pk>/edit/', views.ServiceUpdateView.as_view(), name='service_edit'),
    path('dashboard/company/services/<uuid:pk>/delete/', views.ServiceDeleteView.as_view(), name='service_delete'),
