(function($) {
    ...
    console.log('Service admin JavaScript loaded');
    ...
    $(document).ready(function() {
        ...
        console.log('Category field found:', categoryField.length);
        console.log('Subcategory field found:', subcategoryField.length);
